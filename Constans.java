...
public class Constans {
    ...
    public static final String QUESTION_EXIST_NODELET="项目有发布中的问卷，不可以删除";
    ...
    public static final String COPY_EXIT_UPDATE_MESSAGE = "问卷发布中，不可编辑";
    public static final String STOP_EXIT_UPDATE_MESSAGE = "强制结束已开启问卷，编辑成功";
