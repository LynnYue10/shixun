...
function getProjectQuest() {
    ...
    //     '\t"data": [{\n' +
    //     '\t\t"projectContent": "项目名",\n' +
    //     '\t\t"id": "708a580ce83c49c0a0cfc65b151d690e",\n' +
    //     '\t\t"projectName": "静态测试数据",\n' +
    //     '\t\t"createDate": "2022-05-13T15:05:40"\n' +
    //     '\t},{\n' +
    //     '\t\t"projectContent": "项目名",\n' +
    //     '\t\t"id": "708a580ce83c49c0a0cfc65b151d690e",\n' +
    //     '\t\t"projectName": "111静态测试数据",\n' +
    //     '\t\t"createDate": "2022-05-13T15:05:40"\n' +
    //     '\t},{\n' +
    //     '\t\t"projectContent": "项目名",\n' +
    //     '\t\t"id": "708a580ce83c49c0a0cfc65b151d690e",\n' +
    ...
    if (result.code == "666") {
        ...
        if (data.length) {
            for (var i = 0; i < data.length; i++) {
                ...
                var projectContent = projectInfo.projectContent;
                ...
                text += "         <a class=\"panel-title\" title='项目名称' data-toggle=\"collapse\" id=\"projcetNumber" + i + "\" data-parent=\"#panel-23802\" href=\"#panel-element-" + projectInfo.id + "\">" + projectName + "</a>";
               // text += "         <a class=\"panel-title\" title='项目说明'  data-toggle=\"collapse\" id=\"projcetNumber" + i + "\" data-parent=\"#panel-23802\" href=\"#panel-element-" + projectInfo.id + "\">" + projectContent + "</a>";
                text += "";
